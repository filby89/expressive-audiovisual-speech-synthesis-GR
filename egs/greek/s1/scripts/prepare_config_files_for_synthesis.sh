...
echo "output_features      : ['mgc', 'lf0', 'vuv', 'bap', 'sha', 'tex']" >> $acoustic_config_file
echo "gen_wav_features     : ['mgc', 'lf0', 'bap', 'sha', 'tex']" >> $acoustic_config_file
echo "gen_face_features    : ['sha', 'tex']" >> $acoustic_config_file
